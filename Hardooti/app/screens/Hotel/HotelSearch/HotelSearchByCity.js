...
class HotelSearchByCity extends Component {
    constructor(props){
        super(props);
        this.state ={ 
          cityList:[],
          ...
          relativeUrl:'/api/cityList/hotel',
          isLoading:true,
          cityListForSearch:[]
        }
        this.cityList= [];
      ...
      {      
       ...
       {
       this.props.navigation.navigate('HotelListByCity',{city:this.state.searchTerm});  
       }
      }
      onCitySelected(cityName)
      {
       this.setState({searchTerm:cityName});
       this.props.navigation.navigate('HotelListByCity',{city:cityName});
      }
...
export default withNavigation(HotelSearchByCity);
