...
class CafeLocation extends Component {
  constructor(props){
    super(props);
  ...
  render() {
    ...
    var location  = cafe.location.split(",");
    var cafeId = cafe.id;
    return (             
       <Container>
  ...
  <FooterTab style={{backgroundColor:"white"}}>
    ...
    <Button active={true} style={{backgroundColor:"white",color:"#000"}} onPress={() => this.props.navigation.navigate('CafeContactInformation',{cafe:cafe})}>
...
export default withNavigation(CafeLocation);
