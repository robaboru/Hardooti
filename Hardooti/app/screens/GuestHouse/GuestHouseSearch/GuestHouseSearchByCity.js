...
class GuestHouseSearchByCity extends Component {
    constructor(props){
        super(props);
        this.state ={ 
          cityList:[],
          ...
          relativeUrl:'/api/cityList/guestHouse',
          isLoading:true,
          cityListForSearch:[]
        }
        this.cityList= [];
      ...
      {      
       ...
       {
       this.props.navigation.navigate('GuestHouseListByCity',{city:this.state.searchTerm});  
       }
      }
      onCitySelected(cityName)
      {
       this.setState({searchTerm:cityName});
       this.props.navigation.navigate('GuestHouseListByCity',{city:cityName});
      }
...
export default withNavigation(GuestHouseSearchByCity);
