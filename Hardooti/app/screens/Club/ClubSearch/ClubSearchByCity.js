...
class ClubSearchByCity extends Component {
    constructor(props){
        super(props);
        this.state ={ 
          cityList:[],
      ...
      {      
       ...
       {
       this.props.navigation.navigate('ClubListByCity',{city:this.state.searchTerm});  
       }
      }
      onCitySelected(cityName)
      {
       this.setState({searchTerm:cityName});
       this.props.navigation.navigate('ClubListByCity',{city:cityName});
      }
...
export default withNavigation(ClubSearchByCity);
