...
class EventLocation extends Component {
  ...
  <FooterTab style={{backgroundColor:"white"}}>
    ...
    <Button active={true} style={{backgroundColor:"white",color:"#000"}} onPress={() => this.props.navigation.navigate('EventInformation',{event:event})}>
...
export default withNavigation(EventLocation);
