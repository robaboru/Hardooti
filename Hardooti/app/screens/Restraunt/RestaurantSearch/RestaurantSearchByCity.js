...
class RestaurantSearchByCity extends Component {
    constructor(props){
        super(props);
        this.state ={ 
          cityList:[],
          ...
          relativeUrl:'/api/cityList/restaurant',
          isLoading:true,
          cityListForSearch:[]
        }
        this.cityList= [];
      ...
      {      
       ...
       {
       this.props.navigation.navigate('RestaurantListByCity',{city:this.state.searchTerm});  
       }
      }
      onCitySelected(cityName)
      {
       this.setState({searchTerm:cityName});
       this.props.navigation.navigate('RestaurantListByCity',{city:cityName});
      }
...
export default withNavigation(RestaurantSearchByCity);
